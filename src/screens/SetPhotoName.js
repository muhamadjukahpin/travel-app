...
const SetPhotoName = ({ route }) => {
  ...
  const [image, setImage] = useState(
    "https://i.pinimg.com/originals/21/1b/25/211b2554a3b2f53e4db9f4f8c04263a9.png"
  );
      ...
      .add({
        ...
        image_name:
          Object.keys(img).length > 0
            ? img.path.split("/").pop()
            : "211b2554a3b2f53e4db9f4f8c04263a9.png",
        image_path: Object.keys(img).length > 0 ? img.path : image,
      })
      .then(() => {
        console.log("add user", name, email, img);
      });
  };
        ...
        <View style={styles.lower}>
          ...
          <View style={{ flexDirection: "row", alignSelf: "center" }}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Login")}>
              <Text
                style={[styles.loginText, { fontFamily: "AlongSansExtraBold" }]}
              >
                {" "}
                Log in{" "}
              </Text>
