...
const Card2 = ({ locName, rating, location, time }) => {
  ...
  const handleBookmark = () => {
    ...
    if (bookmark == true) {
      alert(locName + " has been added to your bookmarks!");
      ...
      alert(locName + " has been removed from your bookmarks!");
    }
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.align}>
        <Text style={styles.text}>{locName}</Text>
      ...
      {displayTime && (
        <View
          style={[styles.align, { justifyContent: null, left: 40, top: 30 }]}
        >
